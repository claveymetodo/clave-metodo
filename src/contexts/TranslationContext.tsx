...
const translations = {
  es: {
    ...
    'historia.jennifer.p3': 'Esta experiencia me permitió profundizar en la gestión financiera de empresas de servicios y ampliar mi conocimiento en el área administrativa-contable. Hoy, toda esta trayectoria me motiva a emprender mi propio proyecto profesional, con el compromiso de contribuir al crecimiento y desarrollo de las empresas, ofreciendo un servicio contable cercano, eficiente y confiable.',
     'historia.jennifer.experience': '8 años',
     'historia.jennifer.experience-label': 'Experiencia',
     'historia.jennifer.clients': 'Optimización de Procesos',
     'historia.jennifer.clients-label': 'Contables Especialidad',
  ...
  en: {
    ...
    'historia.jennifer.p3': 'This experience allowed me to deepen my knowledge in financial management of service companies and expand my knowledge in the administrative-accounting area. Today, all this trajectory motivates me to start my own professional project, with the commitment to contribute to the growth and development of companies, offering a close, efficient and reliable accounting service.',
     'historia.jennifer.experience': '8 years',
     'historia.jennifer.experience-label': 'Experience',
     'historia.jennifer.clients': 'Accounting Process',
     'historia.jennifer.clients-label': 'Optimization Specialty',
     'historia.jennifer.expert': '100%',
