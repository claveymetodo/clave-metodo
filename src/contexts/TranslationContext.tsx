...
const translations = {
  ...
  en: {
    ...
    'historia.subtitle': "We'd love to share this:",
    ...
    'historia.p3': 'At the beginning of 2025, we decided to combine our magic and create our first company from scratch. We took care of the entire process: registration, licenses and accounting, helping a businessperson with a spectacular idea who needed support to develop it.',
    ...
    'historia.p5': 'The key of the business represents the "C" of Cordero, Jennifer\'s surname, who is the financial root of the business, leading everything related to finances and ensuring that each project meets the necessary requirements to prosper.',
     ...
     'historia.p7': "Together, we'll walk every step of the path to your success....",
     'historia.signature': 'Jennifer & Paola',
    'historia.paola.name': 'Paola Marín Trejos',
    ...
    'historia.together.title': 'Our Strength Is in Unity',
    ...
    'historia.together.p2': 'We firmly believe that every businessperson deserves access to quality professional advice, without obstacles. That\'s why we dedicate ourselves to being the bridge between your business vision and its successful realization.',
    'historia.together.focus': '100%',
    ...
    // Portfolio Section - Why Choose Us
    'portfolio.title': 'Why Choose Clave & Método',
